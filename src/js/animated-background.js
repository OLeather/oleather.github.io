 ...
 const Polyline = (function () {
    ...
    function initDarkScene(){
        conf.nx = 75;
        const colors = [], n = 4;
        colors.push(chroma('#001442'));
        colors.push(chroma('#262451'));
        colors.push(chroma('#4D335F'));
        colors.push(chroma('#73436E'));

        conf.cscale = chroma.scale(colors).mode('lch');
    ...
    function initLightScene(){
        conf.nx = 75;
        const colors = [], n = 4;
        colors.push(chroma('#D6D6D6'));
        colors.push(chroma('#D0BACE'));
        colors.push(chroma('#CA9FC5'));
        colors.push(chroma('#C483BD'));
